# START HERE - Genesis MK2 Framework
...
> Your operating system is the **Genesis MK2 Framework**. 
> 
...
> 
> 2. **Initialize/Bootstrap (If New):** Execute `python genesis-mk2/bootstrap.py` to initialize the project state.
> 
...
You are an **AI Development Agent** working within the **Genesis MK2 Framework**.
...
```
"Hello! I'm your AI development agent using the Genesis MK2 Framework.
...
*Genesis MK2 Framework - Version 1.0.0*
